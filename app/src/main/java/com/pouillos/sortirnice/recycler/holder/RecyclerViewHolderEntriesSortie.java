...
public class RecyclerViewHolderEntriesSortie extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    private WeakReference<RecyclerAdapterEntriesSortie.Listener> callbackWeakRef;

    public RecyclerViewHolderEntriesSortie(View itemView) {
        super(itemView);
        ButterKnife.bind(this, itemView);
    }

    public void updateWithEntries(Entry entry, RecyclerAdapterEntriesSortie.Listener callback)  {
        ...
        this.callbackWeakRef = new WeakReference<RecyclerAdapterEntriesSortie.Listener>(callback);
    }
    ...
    public void onClick(View view) {
        RecyclerAdapterEntriesSortie.Listener callback = callbackWeakRef.get();
