...
public class RecyclerViewHolderEntriesRestaurant extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    private WeakReference<RecyclerAdapterEntriesRestaurant.Listener> callbackWeakRef;

    public RecyclerViewHolderEntriesRestaurant(View itemView) {
        super(itemView);
        ButterKnife.bind(this, itemView);
    }

    public void updateWithEntries(Entry entry, RecyclerAdapterEntriesRestaurant.Listener callback)  {
        ...
        this.callbackWeakRef = new WeakReference<RecyclerAdapterEntriesRestaurant.Listener>(callback);
    }
    ...
    public void onClick(View view) {
        RecyclerAdapterEntriesRestaurant.Listener callback = callbackWeakRef.get();
