...
public class RecyclerViewHolderEntriesShopping extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    private WeakReference<RecyclerAdapterEntriesShopping.Listener> callbackWeakRef;

    public RecyclerViewHolderEntriesShopping(View itemView) {
        super(itemView);
        ButterKnife.bind(this, itemView);
    }

    public void updateWithEntries(Entry entry, RecyclerAdapterEntriesShopping.Listener callback)  {
        ...
        this.callbackWeakRef = new WeakReference<RecyclerAdapterEntriesShopping.Listener>(callback);
    }
    ...
    public void onClick(View view) {
        RecyclerAdapterEntriesShopping.Listener callback = callbackWeakRef.get();
