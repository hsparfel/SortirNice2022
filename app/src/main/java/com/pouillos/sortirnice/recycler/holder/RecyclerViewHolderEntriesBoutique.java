...
public class RecyclerViewHolderEntriesBoutique extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    private WeakReference<RecyclerAdapterEntriesBoutique.Listener> callbackWeakRef;

    public RecyclerViewHolderEntriesBoutique(View itemView) {
        super(itemView);
        ButterKnife.bind(this, itemView);
    }

    public void updateWithEntries(Entry entry, RecyclerAdapterEntriesBoutique.Listener callback)  {
        ...
        this.callbackWeakRef = new WeakReference<RecyclerAdapterEntriesBoutique.Listener>(callback);
    }
    ...
    public void onClick(View view) {
        RecyclerAdapterEntriesBoutique.Listener callback = callbackWeakRef.get();
