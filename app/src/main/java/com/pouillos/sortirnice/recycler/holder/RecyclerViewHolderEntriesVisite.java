...
public class RecyclerViewHolderEntriesVisite extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    private WeakReference<RecyclerAdapterEntriesVisite.Listener> callbackWeakRef;

    public RecyclerViewHolderEntriesVisite(View itemView) {
        super(itemView);
        ButterKnife.bind(this, itemView);
    }

    public void updateWithEntries(Entry entry, RecyclerAdapterEntriesVisite.Listener callback)  {
        ...
        this.callbackWeakRef = new WeakReference<RecyclerAdapterEntriesVisite.Listener>(callback);
    }
    ...
    public void onClick(View view) {
        RecyclerAdapterEntriesVisite.Listener callback = callbackWeakRef.get();
