...
public class RecyclerViewHolderEntriesHebergement extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    private WeakReference<RecyclerAdapterEntriesHebergement.Listener> callbackWeakRef;

    public RecyclerViewHolderEntriesHebergement(View itemView) {
        super(itemView);
        ButterKnife.bind(this, itemView);
    }

    public void updateWithEntries(Entry entry, RecyclerAdapterEntriesHebergement.Listener callback)  {
        ...
        this.callbackWeakRef = new WeakReference<RecyclerAdapterEntriesHebergement.Listener>(callback);
    }
    ...
    public void onClick(View view) {
        RecyclerAdapterEntriesHebergement.Listener callback = callbackWeakRef.get();
