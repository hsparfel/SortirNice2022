...
public class RecyclerViewHolderEntriesTransport extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    private WeakReference<RecyclerAdapterEntriesTransport.Listener> callbackWeakRef;

    public RecyclerViewHolderEntriesTransport(View itemView) {
        super(itemView);
        ButterKnife.bind(this, itemView);
    }

    public void updateWithEntries(Entry entry, RecyclerAdapterEntriesTransport.Listener callback)  {
        ...
        this.callbackWeakRef = new WeakReference<RecyclerAdapterEntriesTransport.Listener>(callback);
    }
    ...
    public void onClick(View view) {
        RecyclerAdapterEntriesTransport.Listener callback = callbackWeakRef.get();
