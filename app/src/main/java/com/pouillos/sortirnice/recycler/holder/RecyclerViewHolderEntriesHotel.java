...
public class RecyclerViewHolderEntriesHotel extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    private WeakReference<RecyclerAdapterEntriesHotel.Listener> callbackWeakRef;

    public RecyclerViewHolderEntriesHotel(View itemView) {
        super(itemView);
        ButterKnife.bind(this, itemView);
    }

    public void updateWithEntries(Entry entry, RecyclerAdapterEntriesHotel.Listener callback)  {
        ...
        this.callbackWeakRef = new WeakReference<RecyclerAdapterEntriesHotel.Listener>(callback);
    }
    ...
    public void onClick(View view) {
        RecyclerAdapterEntriesHotel.Listener callback = callbackWeakRef.get();
