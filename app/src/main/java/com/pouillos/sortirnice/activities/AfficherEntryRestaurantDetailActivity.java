...
public class AfficherEntryRestaurantDetailActivity extends NavDrawerActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_afficher_detail_entry_restaurant);
    ...
    public void delete(View view) {
        ...
        ouvrirActiviteSuivante(this, AfficherChoixEnregistrementActivity.class,true, EntriesType.Restaurant);
        //AfficherChoixEnregistrementActivity.getInstance().chipRestaurant.setChecked(true);
    }
