...
public class AfficherEntryShoppingDetailActivity extends NavDrawerActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_afficher_detail_entry_shopping);
    ...
    public void delete(View view) {
        ...
        ouvrirActiviteSuivante(this, AfficherChoixEnregistrementActivity.class,true, EntriesType.Shopping);
        //AfficherChoixEnregistrementActivity.getInstance().chipShopping.setChecked(true);
    }
