...
public class AfficherEntryVisiteDetailActivity extends NavDrawerActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_afficher_detail_entry_visite);
    ...
    public void delete(View view) {
        ...
        ouvrirActiviteSuivante(this, AfficherChoixEnregistrementActivity.class,true, EntriesType.Visite);
        //AfficherChoixEnregistrementActivity.getInstance().chipVisite.setChecked(true);
    }
