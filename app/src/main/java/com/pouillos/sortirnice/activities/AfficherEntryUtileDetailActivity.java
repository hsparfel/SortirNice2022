...
public class AfficherEntryUtileDetailActivity extends NavDrawerActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_afficher_detail_entry_utile);
    ...
    public void delete(View view) {
        ...
        ouvrirActiviteSuivante(this, AfficherChoixEnregistrementActivity.class,true, EntriesType.Utile);
        //AfficherChoixEnregistrementActivity.getInstance().chipUtile.setChecked(true);
    }
