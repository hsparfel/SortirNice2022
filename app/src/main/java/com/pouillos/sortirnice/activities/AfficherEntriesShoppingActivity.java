...
import com.pouillos.sortirnice.interfaces.EntriesShoppingApiService;
import com.pouillos.sortirnice.interfaces.EntriesShoppingApiService;
...
public class AfficherEntriesShoppingActivity extends NavDrawerActivity implements RecyclerAdapterEntriesShopping.Listener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_afficher_entry_shopping);
    ...
    public void connectAndGetApiData(String url) {
        ...
        Call<Entries> call = entriesShoppingApiService.getEntries();
        ...
        ItemClickSupport.addTo(list_recycler_event, R.layout.recycler_list_event)
                .setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
                    ...
                    public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                        //ouvrirActiviteSuivante(AfficherEntriesShoppingActivity.this, AfficherEntryShoppingDetailActivity.class,"entryId",listEntryEntities.get(position).getId(),false);
                        Log.e("TAG", "Position : "+position);
                        selectedEntry = listEntries.get(position);
                        fillAllFields();
                        hideFields();
                        AfficherEntriesShoppingActivity.AsyncTaskRunnerImage runnerImage = new AfficherEntriesShoppingActivity.AsyncTaskRunnerImage();
                        runnerImage.execute();
                        afficherDetail(true);
                    }
                });
    ...
    public void fabSaveClick() {
        saveEntry(selectedEntry,EntriesType.Shopping);
