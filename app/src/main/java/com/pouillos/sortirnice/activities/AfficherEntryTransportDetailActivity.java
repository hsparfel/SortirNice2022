...
public class AfficherEntryTransportDetailActivity extends NavDrawerActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_afficher_detail_entry_transport);
    ...
    public void delete(View view) {
        ...
        ouvrirActiviteSuivante(this, AfficherChoixEnregistrementActivity.class,true, EntriesType.Transport);
        //AfficherChoixEnregistrementActivity.getInstance().chipTransport.setChecked(true);
    }
