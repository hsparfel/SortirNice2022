...
public class AfficherEntriesHebergementActivity extends NavDrawerActivity implements RecyclerAdapterEntriesHebergement.Listener {
        ...
        ItemClickSupport.addTo(list_recycler_event, R.layout.recycler_list_event)
                .setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
                    ...
                    public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                        //ouvrirActiviteSuivante(AfficherEntriesHebergementActivity.this, AfficherEntryHebergementDetailActivity.class,"entryId",listEntryEntities.get(position).getId(),false);
                        Log.e("TAG", "Position : "+position);
                        selectedEntry = listEntries.get(position);
                        fillAllFields();
                        hideFields();
                        AfficherEntriesHebergementActivity.AsyncTaskRunnerImage runnerImage = new AfficherEntriesHebergementActivity.AsyncTaskRunnerImage();
                        runnerImage.execute();
                        afficherDetail(true);
                    }
                });
