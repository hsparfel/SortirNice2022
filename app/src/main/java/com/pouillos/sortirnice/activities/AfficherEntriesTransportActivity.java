...
import com.pouillos.sortirnice.recycler.adapter.RecyclerAdapterEntriesTransport;
import com.pouillos.sortirnice.recycler.adapter.RecyclerAdapterEntriesTransport;
...
public class AfficherEntriesTransportActivity extends NavDrawerActivity implements RecyclerAdapterEntriesTransport.Listener {
    ...
    private RecyclerAdapterEntriesTransport adapterEntries;
        ...
        ItemClickSupport.addTo(list_recycler_event, R.layout.recycler_list_event)
                .setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
                    ...
                    public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                        //ouvrirActiviteSuivante(AfficherEntriesTransportActivity.this, AfficherEntryTransportDetailActivity.class,"entryId",listEntryEntities.get(position).getId(),false);
                        Log.e("TAG", "Position : "+position);
                        selectedEntry = listEntries.get(position);
                        fillAllFields();
                        hideFields();
                        AfficherEntriesTransportActivity.AsyncTaskRunnerImage runnerImage = new AfficherEntriesTransportActivity.AsyncTaskRunnerImage();
                        runnerImage.execute();
                        afficherDetail(true);
                    }
                });
    ...
    public void configureRecyclerView() {
        adapterEntries = new RecyclerAdapterEntriesTransport(listEntries, this);
