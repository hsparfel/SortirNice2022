...
public class AfficherEntriesBoutiqueActivity extends NavDrawerActivity implements RecyclerAdapterEntriesBoutique.Listener {
        ...
        ItemClickSupport.addTo(list_recycler_event, R.layout.recycler_list_event)
                .setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
                    ...
                    public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                        ...
                        fillAllFields();
                        hideFields();
                        AfficherEntriesBoutiqueActivity.AsyncTaskRunnerImage runnerImage = new AfficherEntriesBoutiqueActivity.AsyncTaskRunnerImage();
                        runnerImage.execute();
                        afficherDetail(true);
                    }
                });
