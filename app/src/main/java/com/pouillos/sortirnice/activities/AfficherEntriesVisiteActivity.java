...
import com.pouillos.sortirnice.interfaces.EntriesVisiteApiService;
import com.pouillos.sortirnice.interfaces.EntriesVisiteApiService;
...
import com.pouillos.sortirnice.recycler.adapter.RecyclerAdapterEntriesVisite;
import com.pouillos.sortirnice.recycler.adapter.RecyclerAdapterEntriesVisite;
...
public class AfficherEntriesVisiteActivity extends NavDrawerActivity implements RecyclerAdapterEntriesVisite.Listener {
    ...
    private RecyclerAdapterEntriesVisite adapterEntries;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_afficher_entry_visite);
        ...
        ItemClickSupport.addTo(list_recycler_event, R.layout.recycler_list_event)
                .setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
                    ...
                    public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                        //ouvrirActiviteSuivante(AfficherEntriesVisiteActivity.this, AfficherEntryVisiteDetailActivity.class,"entryId",listEntryEntities.get(position).getId(),false);
                        Log.e("TAG", "Position : "+position);
                        selectedEntry = listEntries.get(position);
                        fillAllFields();
                        hideFields();
                        AfficherEntriesVisiteActivity.AsyncTaskRunnerImage runnerImage = new AfficherEntriesVisiteActivity.AsyncTaskRunnerImage();
                        runnerImage.execute();
                        afficherDetail(true);
                    }
                });
    ...
    public void configureRecyclerView() {
        adapterEntries = new RecyclerAdapterEntriesVisite(listEntries, this);
