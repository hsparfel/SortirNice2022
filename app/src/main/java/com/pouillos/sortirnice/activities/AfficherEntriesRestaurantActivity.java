...
public class AfficherEntriesRestaurantActivity extends NavDrawerActivity implements RecyclerAdapterEntries.Listener {
    ...
    private void saveListEntries() {
        ...
        for (Entry current : listEntries) {
            ...
            if (listEntriesFound.size()==0) {
                ...
                entryToSave.setEntryType(EntriesType.Restaurant);
