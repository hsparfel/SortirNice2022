...
import com.pouillos.sortirnice.interfaces.EntriesRestaurantApiService;
import com.pouillos.sortirnice.interfaces.EntriesRestaurantApiService;
...
import com.pouillos.sortirnice.recycler.adapter.RecyclerAdapterEntriesRestaurant;
import com.pouillos.sortirnice.recycler.adapter.RecyclerAdapterEntriesRestaurant;
...
public class AfficherEntriesRestaurantActivity extends NavDrawerActivity implements RecyclerAdapterEntriesRestaurant.Listener {
    ...
    private RecyclerAdapterEntriesRestaurant adapterEntries;

    private static final String TAG = AfficherEntriesRestaurantActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_afficher_entry_restaurant);
    ...
    public void connectAndGetApiData(String url) {
        ...
        Call<Entries> call = entriesRestaurantApiService.getEntries();
        ...
        ItemClickSupport.addTo(list_recycler_event, R.layout.recycler_list_event)
                .setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
                    ...
                    public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                        //ouvrirActiviteSuivante(AfficherEntriesRestaurantActivity.this, AfficherEntryRestaurantDetailActivity.class,"entryId",listEntryEntities.get(position).getId(),false);
                        Log.e("TAG", "Position : "+position);
                        selectedEntry = listEntries.get(position);
                        fillAllFields();
                        hideFields();
                        AfficherEntriesRestaurantActivity.AsyncTaskRunnerImage runnerImage = new AfficherEntriesRestaurantActivity.AsyncTaskRunnerImage();
                        runnerImage.execute();
                        afficherDetail(true);
                    }
                });
    ...
    public void configureRecyclerView() {
        adapterEntries = new RecyclerAdapterEntriesRestaurant(listEntries, this);
    ...
    public void fabSaveClick() {
        saveEntry(selectedEntry,EntriesType.Restaurant);
