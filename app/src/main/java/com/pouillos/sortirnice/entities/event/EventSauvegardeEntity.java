package com.pouillos.sortirnice.entities.event;
...
@Entity
public class EventSauvegardeEntity implements Comparable<EventSauvegardeEntity> {
    ...
    @Generated(hash = 649669145)
    public EventSauvegardeEntity(Long id, Long eventId, String nameFr, String start,
    ...
    @Generated(hash = 65718779)
    public EventSauvegardeEntity() {
    }

    @Override
    public int compareTo(EventSauvegardeEntity o) {
