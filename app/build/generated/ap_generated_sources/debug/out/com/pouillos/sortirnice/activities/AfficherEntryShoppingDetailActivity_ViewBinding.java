...
public class AfficherEntryShoppingDetailActivity_ViewBinding implements Unbinder {
  private AfficherEntryShoppingDetailActivity target;

  @UiThread
  public AfficherEntryShoppingDetailActivity_ViewBinding(
      AfficherEntryShoppingDetailActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public AfficherEntryShoppingDetailActivity_ViewBinding(AfficherEntryShoppingDetailActivity target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    AfficherEntryShoppingDetailActivity target = this.target;
