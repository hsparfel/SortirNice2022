...
public class RecyclerViewHolderEntriesRestaurant_ViewBinding implements Unbinder {
  private RecyclerViewHolderEntriesRestaurant target;

  @UiThread
  public RecyclerViewHolderEntriesRestaurant_ViewBinding(RecyclerViewHolderEntriesRestaurant target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    RecyclerViewHolderEntriesRestaurant target = this.target;
