...
public class AfficherEntryVisiteDetailActivity_ViewBinding implements Unbinder {
  private AfficherEntryVisiteDetailActivity target;

  @UiThread
  public AfficherEntryVisiteDetailActivity_ViewBinding(AfficherEntryVisiteDetailActivity target) {
  ...
  @CallSuper
  public void unbind() {
    AfficherEntryVisiteDetailActivity target = this.target;
