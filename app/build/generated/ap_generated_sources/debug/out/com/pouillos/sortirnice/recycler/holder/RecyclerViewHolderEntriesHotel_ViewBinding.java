...
public class RecyclerViewHolderEntriesHotel_ViewBinding implements Unbinder {
  private RecyclerViewHolderEntriesHotel target;

  @UiThread
  public RecyclerViewHolderEntriesHotel_ViewBinding(RecyclerViewHolderEntriesHotel target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    RecyclerViewHolderEntriesHotel target = this.target;
