...
public class RecyclerViewHolderEntriesShopping_ViewBinding implements Unbinder {
  private RecyclerViewHolderEntriesShopping target;

  @UiThread
  public RecyclerViewHolderEntriesShopping_ViewBinding(RecyclerViewHolderEntriesShopping target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    RecyclerViewHolderEntriesShopping target = this.target;
