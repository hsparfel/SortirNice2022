...
public class AfficherEntriesVisiteActivity_ViewBinding implements Unbinder {
  private AfficherEntriesVisiteActivity target;

  private View view7f0800ce;

  @UiThread
  public AfficherEntriesVisiteActivity_ViewBinding(AfficherEntriesVisiteActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public AfficherEntriesVisiteActivity_ViewBinding(final AfficherEntriesVisiteActivity target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    AfficherEntriesVisiteActivity target = this.target;
