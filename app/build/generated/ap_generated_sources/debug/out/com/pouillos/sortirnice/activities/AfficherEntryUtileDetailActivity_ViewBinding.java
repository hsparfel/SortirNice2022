...
public class AfficherEntryUtileDetailActivity_ViewBinding implements Unbinder {
  private AfficherEntryUtileDetailActivity target;

  @UiThread
  public AfficherEntryUtileDetailActivity_ViewBinding(AfficherEntryUtileDetailActivity target) {
  ...
  @CallSuper
  public void unbind() {
    AfficherEntryUtileDetailActivity target = this.target;
