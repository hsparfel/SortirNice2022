...
public class RecyclerViewHolderEntriesSortie_ViewBinding implements Unbinder {
  private RecyclerViewHolderEntriesSortie target;

  @UiThread
  public RecyclerViewHolderEntriesSortie_ViewBinding(RecyclerViewHolderEntriesSortie target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    RecyclerViewHolderEntriesSortie target = this.target;
