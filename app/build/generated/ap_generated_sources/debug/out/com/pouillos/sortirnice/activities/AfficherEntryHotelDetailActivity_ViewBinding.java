...
public class AfficherEntryHotelDetailActivity_ViewBinding implements Unbinder {
  private AfficherEntryHotelDetailActivity target;

  @UiThread
  public AfficherEntryHotelDetailActivity_ViewBinding(AfficherEntryHotelDetailActivity target) {
  ...
  @CallSuper
  public void unbind() {
    AfficherEntryHotelDetailActivity target = this.target;
