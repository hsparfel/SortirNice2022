...
public class AfficherEntryTransportDetailActivity_ViewBinding implements Unbinder {
  private AfficherEntryTransportDetailActivity target;

  @UiThread
  public AfficherEntryTransportDetailActivity_ViewBinding(
      AfficherEntryTransportDetailActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public AfficherEntryTransportDetailActivity_ViewBinding(
      AfficherEntryTransportDetailActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    AfficherEntryTransportDetailActivity target = this.target;
