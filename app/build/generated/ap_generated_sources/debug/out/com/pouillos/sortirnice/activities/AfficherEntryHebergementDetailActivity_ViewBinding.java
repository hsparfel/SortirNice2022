...
public class AfficherEntryHebergementDetailActivity_ViewBinding implements Unbinder {
  private AfficherEntryHebergementDetailActivity target;

  @UiThread
  public AfficherEntryHebergementDetailActivity_ViewBinding(
      AfficherEntryHebergementDetailActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public AfficherEntryHebergementDetailActivity_ViewBinding(
      AfficherEntryHebergementDetailActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    AfficherEntryHebergementDetailActivity target = this.target;
