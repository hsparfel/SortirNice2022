...
public class RecyclerViewHolderEntriesBoutique_ViewBinding implements Unbinder {
  private RecyclerViewHolderEntriesBoutique target;

  @UiThread
  public RecyclerViewHolderEntriesBoutique_ViewBinding(RecyclerViewHolderEntriesBoutique target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    RecyclerViewHolderEntriesBoutique target = this.target;
