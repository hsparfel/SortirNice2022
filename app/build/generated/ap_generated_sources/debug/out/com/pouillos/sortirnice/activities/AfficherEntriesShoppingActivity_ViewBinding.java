...
public class AfficherEntriesShoppingActivity_ViewBinding implements Unbinder {
  private AfficherEntriesShoppingActivity target;

  private View view7f0800ce;

  @UiThread
  public AfficherEntriesShoppingActivity_ViewBinding(AfficherEntriesShoppingActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public AfficherEntriesShoppingActivity_ViewBinding(final AfficherEntriesShoppingActivity target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    AfficherEntriesShoppingActivity target = this.target;
    ...
    view7f0800ce.setOnClickListener(null);
    view7f0800ce = null;
  }
}
