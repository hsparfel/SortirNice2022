...
public class RecyclerViewHolderEntriesTransport_ViewBinding implements Unbinder {
  private RecyclerViewHolderEntriesTransport target;

  @UiThread
  public RecyclerViewHolderEntriesTransport_ViewBinding(RecyclerViewHolderEntriesTransport target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    RecyclerViewHolderEntriesTransport target = this.target;
