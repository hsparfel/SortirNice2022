...
public class AfficherEntriesSortieActivity_ViewBinding implements Unbinder {
  private AfficherEntriesSortieActivity target;

  private View view7f0800ce;

  @UiThread
  public AfficherEntriesSortieActivity_ViewBinding(AfficherEntriesSortieActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public AfficherEntriesSortieActivity_ViewBinding(final AfficherEntriesSortieActivity target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    AfficherEntriesSortieActivity target = this.target;
