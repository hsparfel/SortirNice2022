...
public class AfficherEntryRestaurantDetailActivity_ViewBinding implements Unbinder {
  private AfficherEntryRestaurantDetailActivity target;

  @UiThread
  public AfficherEntryRestaurantDetailActivity_ViewBinding(
      AfficherEntryRestaurantDetailActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public AfficherEntryRestaurantDetailActivity_ViewBinding(
      AfficherEntryRestaurantDetailActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    AfficherEntryRestaurantDetailActivity target = this.target;
