...
public class AfficherEntryBoutiqueDetailActivity_ViewBinding implements Unbinder {
  private AfficherEntryBoutiqueDetailActivity target;

  @UiThread
  public AfficherEntryBoutiqueDetailActivity_ViewBinding(
      AfficherEntryBoutiqueDetailActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public AfficherEntryBoutiqueDetailActivity_ViewBinding(AfficherEntryBoutiqueDetailActivity target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    AfficherEntryBoutiqueDetailActivity target = this.target;
