...
public class RecyclerViewHolderEntriesHebergement_ViewBinding implements Unbinder {
  private RecyclerViewHolderEntriesHebergement target;

  @UiThread
  public RecyclerViewHolderEntriesHebergement_ViewBinding(
      RecyclerViewHolderEntriesHebergement target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    RecyclerViewHolderEntriesHebergement target = this.target;
