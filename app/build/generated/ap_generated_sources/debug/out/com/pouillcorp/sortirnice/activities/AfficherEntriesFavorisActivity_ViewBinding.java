...
public class AfficherEntriesFavorisActivity_ViewBinding implements Unbinder {
  private AfficherEntriesFavorisActivity target;
  ...
  @UiThread
  public AfficherEntriesFavorisActivity_ViewBinding(AfficherEntriesFavorisActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public AfficherEntriesFavorisActivity_ViewBinding(final AfficherEntriesFavorisActivity target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    AfficherEntriesFavorisActivity target = this.target;
